...
public class ProfileCustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_customer = (Spinner) findViewById(R.id.spinner_province_cus);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(ProfileCustomer.this, R.array.select_Province, android.R.layout.simple_spinner_item);
    ...
    public void ButtonClickeCreated(View view) {
            ...
            final String Country_Cus = spinner_customer.getSelectedItem().toString().trim();
            ...
            if (!TextUtils.isEmpty(Name_Cus) && !TextUtils.isEmpty(Birthday) && !TextUtils.isEmpty(Address_Cus) &&
                    !TextUtils.isEmpty(Post_Cus) && !TextUtils.isEmpty(Phone_Cus)) {
