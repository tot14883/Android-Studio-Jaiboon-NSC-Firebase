...
public class ProfileTemple extends AppCompatActivity {
    private EditText name_temple, name_Leader, address_temple, post_temple,phone_temple,editFacebook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(ProfileTemple.this, R.array.select_Province, android.R.layout.simple_spinner_item);
    ...
    public void ButtonClickeCreated(View view) {
        ...
        final String Country_Temple = spinner_province.getSelectedItem().toString().trim();
        ...
        if (!TextUtils.isEmpty(Name_Temple) && !TextUtils.isEmpty(Name_Leader) && !TextUtils.isEmpty(Address_Temple) &&
                !TextUtils.isEmpty(Post_Temple) && !TextUtils.isEmpty(Phone_Temple)) {
