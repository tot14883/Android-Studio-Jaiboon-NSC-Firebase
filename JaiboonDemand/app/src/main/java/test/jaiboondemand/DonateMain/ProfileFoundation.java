...
public class ProfileFoundation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_provice = (Spinner) findViewById(R.id.spinner_province_fun);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(ProfileFoundation.this, R.array.select_Province, android.R.layout.simple_spinner_item);
    ...
    public void ButtonClickeCreated(View view) {
        ...
        final String Country_foun = spinner_provice.getSelectedItem().toString().trim();
        ...
        if(!TextUtils.isEmpty(Name_foun) && !TextUtils.isEmpty(Name_Owner) && !TextUtils.isEmpty(Address_foun) &&
            !TextUtils.isEmpty(Post_foun)&& !TextUtils.isEmpty(Phone_foun)) {
