...
public class FoodShop extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        x = inflater.inflate(R.layout.activity_food_shop, container, false);
        mSList = (RecyclerView) x.findViewById(R.id.recycler_food_shop);
        ...
        mQuery = FirebaseDatabase.getInstance().getReference().child("ShopJaiboon").orderByChild("typeproduct").equalTo("Food");
