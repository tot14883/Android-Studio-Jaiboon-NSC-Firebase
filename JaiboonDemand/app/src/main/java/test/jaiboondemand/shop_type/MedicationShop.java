...
public class MedicationShop extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        x = inflater.inflate(R.layout.activity_medication_shop, container, false);
        mSList = (RecyclerView) x.findViewById(R.id.recycler_medication);
        ...
        mQuery = FirebaseDatabase.getInstance().getReference().child("ShopJaiboon").orderByChild("typeproduct").equalTo("Medication");
