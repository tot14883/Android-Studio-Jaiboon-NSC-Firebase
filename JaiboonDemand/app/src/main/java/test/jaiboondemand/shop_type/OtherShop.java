...
public class OtherShop extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        x = inflater.inflate(R.layout.activity_other_shop, container, false);
        mSList = (RecyclerView) x.findViewById(R.id.recycler_other);
        ...
        mQuery = FirebaseDatabase.getInstance().getReference().child("ShopJaiboon").orderByChild("typeproduct").equalTo("Other");
