...
public class factordonate {
    private String image, title_factor, desc_factor, posted_factor, Category,posted;

    public factordonate() {
    }

    public factordonate(String image, String title_factor, String desc_factor, String posted_factor, String Category) {
        this.image = image;
