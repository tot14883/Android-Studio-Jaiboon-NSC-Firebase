...
public class DepositDetail extends AppCompatActivity implements BaseSliderView.OnSliderClickListener,ViewPagerEx.OnPageChangeListener{
    ...
    private TextView yourname,youraddress,yourphone,txt_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_time = (TextView) findViewById(R.id.time_deposit_detail);
        ...
        mData.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String time = (String) dataSnapshot.child("time_deposit").getValue();
